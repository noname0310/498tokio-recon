...
The final scene keeps only its root, five cameras and playback entity resident. The intro, starfield, forward flight, paper flight, landscape, interior, launch and asteroid sequences own their chapter entities as spawnables. Transition overlap remains part of the section ranges. The helmet-room sequence is nested in the interior chapter, retaining that room until frame 2196. Landscape ends at 1727, interior at 2196 launch at 2256 and asteroid field at 2537; their tracks do not continue to the audio endpoint. Image and procedural-result caches belong to Resources and survive chapter exits, while DOM/GPU render objects are disposed. Re-entering a chapter reconstructs the same pose from its tracks.
